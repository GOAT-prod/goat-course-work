...
func RegisterHandler(logger goatlogger.Logger, userService service.User) goathttp.Handler {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		registeredUser, err := userService.AddUser(ctx, user)
		if err != nil {
			w.WriteHeader(http.StatusBadRequest)
		...
		if err = json.WriteResponse(w, http.StatusOK, registeredUser); err != nil {
			w.WriteHeader(http.StatusBadRequest)
