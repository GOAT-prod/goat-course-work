...
func (a *App) initClusterClients() {
	...
	a.clientServiceClient = clientservice.NewClient(cluster.NewBaseClient(a.cfg.ClusterClients.ClientService))
}
...
func (a *App) initServices() {
	...
	a.registrationService = service.NewRegistrationService(a.hasher, a.jwtService, a.userServiceClient, a.clientServiceClient)
}
